					...
					<div class="stats">
						<div class="stats_inner">
							<form action="#" method="post">
								...
								<asp:DropDownList ID="DropDownList_Section_1" class="form-control mb-3" style="padding: 0.375rem 0.75rem; height: calc(2.25rem + 2px);" runat="server">
									<asp:ListItem Value="">Select Specialist</asp:ListItem>
									...
									<asp:ListItem Value="6">Pulmonology</asp:ListItem>
									<asp:ListItem Value="7">Ophthalmology</asp:ListItem>
								...
								<asp:DropDownList ID="DropDownList_gender_1" class="form-control mb-3" style="padding: 0.375rem 0.75rem; height: calc(2.25rem + 2px);" runat="server">
								...
								<input type="date" id="datepicke1" name="datepicke1" class="form-control date mb-3" placeholder="Select Date" required="required" />
